...
\]
Consequently its rank is at most $K=m_1\binom{\ell+1}{2}$.  When both the quotient rank and the affine-constraint rank are generic (i.e., $\rho=K$ and $\lambda_R=M-K$, the case realized in every relation we tested), forging a selected target reduces directly to solving $K$ quadratic equations in
\[
