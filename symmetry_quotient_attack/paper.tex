...
theorems begin in \Cref{sec:sq-overview}.  The remaining main sections give
the artifact evidence, repair bounds, and conclusion.  The appendices record
the Just Guess sensitivity and the low-state XL complement.
...
The streamed-XL appendix makes the additional production-degree premise
fully explicit.
...
\Cref{sec:jg-finite-gate}.  It is not used by either all-nine theorem.
...
\Cref{sec:jg-finite-gate} records a separate Boolean-ledger sensitivity for the
Level-I $\ell=2$ shape.  It remains conditional on an unmeasured Just Guess
multiplier and does not give an unconditional complete-gate break.
...
\clearpage
\appendix
\section{A Boolean-ledger Level-I sensitivity via Just Guess}
