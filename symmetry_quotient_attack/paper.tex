...
The release neither tests $\mathsf H_{\rm hom}$ nor measures
$\kappa_{\rm hom}$, memory, or full gate cost.  The $\AXN$ ledger charges the
stated multiplication schedule; control, data movement, indexing,
factorization, communication, and peak state remain outside it.  Appendix~A
also leaves $\kappa_{\rm JG}$ unmeasured, while Appendix~B does not prove its
production solving degree.
